...
(function () {
    ...
    const rolePageAccess = {
        'student-cspc': ['home.html', 'dashboard.html', 'buildings.html', 'events.html', 'map.html', 'about.html', 'landing.html'],
        'instructor': ['home.html', 'dashboard.html', 'buildings.html', 'events.html', 'map.html', 'about.html', 'landing.html'],
        'admin': ['home.html', 'dashboard.html', 'buildings.html', 'events.html', 'map.html', 'about.html', 'landing.html', 'users.html'],
        'guest': ['home.html', 'dashboard.html', 'buildings.html', 'events.html', 'map.html', 'about.html', 'landing.html']
    };
    ...
    const roleNavAccess = {
        ...
        'guest': ['tabHome', 'tabDashboard', 'tabBuildings', 'tabEvents', 'tabMap', 'tabAbout'] // Guests now see all tabs as requested
    };
    ...
    if (role === 'student-cspc') {
        ...
        // guest or unknown
        const saved = localStorage.getItem('campusphere-non-cspc'); // Check merged guest storage
        const profile = saved ? JSON.parse(saved) : null;
